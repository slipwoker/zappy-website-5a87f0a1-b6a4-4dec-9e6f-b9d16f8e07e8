...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function clearError(field) {
      ...
      const parent = field.closest('.form-group, .field-wrapper') || field.parentNode;
      const existingErrors = parent.querySelectorAll('.form-error-message');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '5a87f0a1-b6a4-4dec-9e6f-b9d16f8e07e8',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '5a87f0a1-b6a4-4dec-9e6f-b9d16f8e07e8';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '5a87f0a1-b6a4-4dec-9e6f-b9d16f8e07e8';
